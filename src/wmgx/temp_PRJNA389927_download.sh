...
#SBATCH -J mp_PRJNA389927
#SBATCH -t 80:00:00
#SBATCH --cpus-per-task=20
#SBATCH --mem=300G
#SBATCH --exclusive
#SBATCH -o /proj/naiss2024-6-169/users/x_xwang/project/mm_network/log/metagenomics/preprocessing/PRJNA389927/3_1_metaphlan.log
#SBATCH -e /proj/naiss2024-6-169/users/x_xwang/project/mm_network/log/metagenomics/preprocessing/PRJNA389927/3_1_metaphlan.err
