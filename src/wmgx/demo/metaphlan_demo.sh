...
#SBATCH --mem=300G
#SBATCH --exclusive
#SBATCH -o /proj/naiss2024-6-169/users/x_xwang/project/microbiota_crc/log/process/BIOPROJECT_PLACEHOLDER_metaphlan_%j.log
#SBATCH -e /proj/naiss2024-6-169/users/x_xwang/project/microbiota_crc/log/process/BIOPROJECT_PLACEHOLDER_metaphlan_%j.err
...
metaphlan_single_end_srr_id() {
    ...
    metaphlan $OUTPUT_DIR/${SRR_ID}/${SRR_ID}_1_kneaddata.fastq \
              --bowtie2out $OUTPUT_DIR/${SRR_ID}ß/${SRR_ID}_metagenome.bowtie2.bz2 \
