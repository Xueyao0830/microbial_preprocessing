...
metaphlan_single_end_srr_id() {
    local SRR_ID=$1
    local INPUT_FILE="$OUTPUT_DIR/${SRR_ID}/${SRR_ID}_1_clean_final_kneaddata.fastq.gz"
...
metaphlan_paired_end_srr_id() {
    local SRR_ID=$1
    local INPUT_FILE_1="$OUTPUT_DIR/${SRR_ID}/${SRR_ID}_1_clean_final_kneaddata_paired_1.fastq.gz"
    local INPUT_FILE_2="$OUTPUT_DIR/${SRR_ID}/${SRR_ID}_1_clean_final_kneaddata_paired_2.fastq.gz"
